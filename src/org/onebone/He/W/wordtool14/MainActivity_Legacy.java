...
public class MainActivity_Legacy extends JFrame{
	...
	public MainActivity_Legacy(){
		...
		fileChooseBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    int returnVal = fc.showOpenDialog(MainActivity_Legacy.this);
			    if(returnVal == JFileChooser.APPROVE_OPTION){
			    	try {
						...
						JOptionPane.showMessageDialog(MainActivity_Legacy.this, "File is not found", "No text source found", JOptionPane.ERROR_MESSAGE);
		...
		convertBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(status == false){
					JOptionPane.showMessageDialog(MainActivity_Legacy.this, "Please select elimination options", "ERROR", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if(!textArea.getText().equals("")){
					...
					if(retFile == null){
						JOptionPane.showMessageDialog(MainActivity_Legacy.this, "Select file or insert text","No text source found", JOptionPane.ERROR_MESSAGE);
					}else{
						try {
							...
							JOptionPane.showMessageDialog(MainActivity_Legacy.this, "Requested file is not found", "No text source found", JOptionPane.ERROR_MESSAGE);
						} catch (IOException e1) {
							JOptionPane.showMessageDialog(MainActivity_Legacy.this, e1.getMessage(), "ERROR",  JOptionPane.ERROR_MESSAGE);
						}
					}
