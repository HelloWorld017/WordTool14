...
public class SwingMainActivity extends JFrame{
	...
	public SwingMainActivity(){
		...
		fileChooseBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    int returnVal = fc.showOpenDialog(SwingMainActivity.this);
			    if(returnVal == JFileChooser.APPROVE_OPTION){
			    	try {
						...
						JOptionPane.showMessageDialog(SwingMainActivity.this, "File is not found", "No text source found", JOptionPane.ERROR_MESSAGE);
					} catch (IOException e1) {
						JOptionPane.showMessageDialog(SwingMainActivity.this, e1.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
					}
			    }
			}
		});
		...
		convertBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(status == false){
					JOptionPane.showMessageDialog(SwingMainActivity.this, "Please select elimination options", "ERROR", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				if(!textArea.getText().equals("")){
					...
					if(retFile == null){
						JOptionPane.showMessageDialog(SwingMainActivity.this, "Select file or insert text","No text source found", JOptionPane.ERROR_MESSAGE);
					}else{
						try {
							...
							JOptionPane.showMessageDialog(SwingMainActivity.this, "Requested file is not found", "No text source found", JOptionPane.ERROR_MESSAGE);
						} catch (IOException e1) {
							JOptionPane.showMessageDialog(SwingMainActivity.this, e1.getMessage(), "ERROR",  JOptionPane.ERROR_MESSAGE);
						}
					}
		...
		setVisible(true);
		JOptionPane.showMessageDialog(SwingMainActivity.this, "Your java version is too low to show the latest version of WordTool 14. \r\nThis version is 1604 and not supported.", "ERROR",  JOptionPane.ERROR_MESSAGE);
	}
